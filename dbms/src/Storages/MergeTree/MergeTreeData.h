...
public:
    ...
    public:
        ...
        DataPartsVector commit(DataPartsLock * acquired_data_parts_lock = nullptr);
    ...
    void removePartsInRangeFromWorkingSet(const MergeTreePartInfo & drop_range, DataPartsLock & lock);
